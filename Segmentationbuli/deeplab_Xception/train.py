...
if __name__ == "__main__":
    ...
    #   如：
    weights_path = "233.h5"
    model.load_weights(weights_path,by_name=True,skip_mismatch=True)  # skip_mismatch表示名字不对的权重就跳过去
    #---------------------------------------------------------------------#
    ...
    reduce_lr = ReduceLROnPlateau(monitor='val_loss', factor=0.5, patience=3, verbose=1)# 学习率减少的方式和论文不同
